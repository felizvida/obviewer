...
- Current release-hardening focus: signed hardened-runtime builds, read-only bookmarks, executable packaging entrypoints, and explicit warnings before opening attachments outside Obviewer
